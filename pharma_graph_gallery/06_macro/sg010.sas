...
ods results;
ods select all;
ods proclabel='SG010:Kaplan-Meier Plot';
...
p'do(*ESC*){unicode "00A0"x}TRTPN(*ESC*){unicode "00A0"x}=(*ESC*){unicode "00A0"x}1(*ESC*){unicode "00A0"x}to(*ESC*){unicode "00A0"x}4;';
...
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}styleattrs(*ESC*){unicode "00A0"x}datacontrastcolors=(black(*ESC*){unicode "00A0"x}red(*ESC*){unicode "00A0"x}blue(*ESC*){unicode "00A0"x}green)';
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}datalinepatterns=(solid(*ESC*){unicode "00A0"x}dash(*ESC*){unicode "00A0"x}longdash(*ESC*){unicode "00A0"x}shortdash)(*ESC*){unicode "00A0"x};';
p'(*ESC*){unicode "00A0"x}';
p'step(*ESC*){unicode "00A0"x}x=time(*ESC*){unicode "00A0"x}y=survival(*ESC*){unicode "00A0"x}/(*ESC*){unicode "00A0"x}group=stratum(*ESC*){unicode "00A0"x}name="step"(*ESC*){unicode "00A0"x}lineattrs=(thickness=2);';
p'scatter(*ESC*){unicode "00A0"x}x=time(*ESC*){unicode "00A0"x}y=censored(*ESC*){unicode "00A0"x}/noerrorcaps(*ESC*){unicode "00A0"x}yerrorupper=tick_marks_upper(*ESC*){unicode "00A0"x}yerrorlower=tick_marks_lower(*ESC*){unicode "00A0"x}errorbarattrs=(pattern=1(*ESC*){unicode "00A0"x}thickness=2)(*ESC*){unicode "00A0"x}markerattrs=(size=0)(*ESC*){unicode "00A0"x}GROUP=stratum;';
p'(*ESC*){unicode "00A0"x}';
...
p'keylegend(*ESC*){unicode "00A0"x}"step"(*ESC*){unicode "00A0"x}/(*ESC*){unicode "00A0"x}location=inside(*ESC*){unicode "00A0"x}position=topright(*ESC*){unicode "00A0"x}across=1(*ESC*){unicode "00A0"x}noborder(*ESC*){unicode "00A0"x}valueattrs=(size=10)(*ESC*){unicode "00A0"x}exclude=("")(*ESC*){unicode "00A0"x};';
