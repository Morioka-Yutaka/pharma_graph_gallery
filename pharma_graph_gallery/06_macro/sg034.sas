...
%macro SG034;
title "SG034:Kaplan-Meier curve with CL band and Median Drop Line";
data dummy_adtte;
attrib
...
ods proclabel="SG034:Kaplan-Meier curve with CL band and Median Drop Line";
...
ods results;
ods select all;
ods proclabel="Kaplan-Meier curve with CL band and Median Drop Line";
...
ods proclabel="SG034:Scatter Plot with Broken X-Axis";
proc odstext;
...
p'TRTP(*ESC*){unicode "00A0"x}=(*ESC*){unicode "00A0"x}choosec(TRTPN,"XXXXX","YYYY","ZZZZZ","Placebo");';
...
p'ods(*ESC*){unicode "00A0"x}output(*ESC*){unicode "00A0"x}Quartiles=Quartiles;';
p'proc(*ESC*){unicode "00A0"x}lifetest(*ESC*){unicode "00A0"x}data=dummy_adtte(*ESC*){unicode "00A0"x}plots=survival(atrisk=0(*ESC*){unicode "00A0"x}to(*ESC*){unicode "00A0"x}15(*ESC*){unicode "00A0"x}by(*ESC*){unicode "00A0"x}1(*ESC*){unicode "00A0"x}cl);';
p'(*ESC*){unicode "00A0"x}time(*ESC*){unicode "00A0"x}AVAL(*ESC*){unicode "00A0"x}*(*ESC*){unicode "00A0"x}CNSR(1);';
p'(*ESC*){unicode "00A0"x}strata(*ESC*){unicode "00A0"x}TRTPN(*ESC*){unicode "00A0"x};';
p'run;';
...
p'(*ESC*){unicode "00A0"x}by(*ESC*){unicode "00A0"x}Stratum;';
p'run;';
...
p'(*ESC*){unicode "00A0"x}where(*ESC*){unicode "00A0"x}^missing(tAtRisk);';
p'(*ESC*){unicode "00A0"x}by(*ESC*){unicode "00A0"x}tAtRisk;';
p'run;';
...
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}tick_marks_upper(*ESC*){unicode "00A0"x}=(*ESC*){unicode "00A0"x}Censored(*ESC*){unicode "00A0"x}+(*ESC*){unicode "00A0"x}0.02;';
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}tick_marks_lower(*ESC*){unicode "00A0"x}=(*ESC*){unicode "00A0"x}Censored(*ESC*){unicode "00A0"x}-(*ESC*){unicode "00A0"x}0.02;';
p'end;';
p'run;';
p'';
p'proc(*ESC*){unicode "00A0"x}sql(*ESC*){unicode "00A0"x}noprint;';
p'(*ESC*){unicode "00A0"x}select(*ESC*){unicode "00A0"x}Estimate(*ESC*){unicode "00A0"x}into:p50_1(*ESC*){unicode "00A0"x}from(*ESC*){unicode "00A0"x}Quartiles';
p'(*ESC*){unicode "00A0"x}where(*ESC*){unicode "00A0"x}Percent=50(*ESC*){unicode "00A0"x}and(*ESC*){unicode "00A0"x}stratum=1;';
p'';
p'(*ESC*){unicode "00A0"x}select(*ESC*){unicode "00A0"x}Estimate(*ESC*){unicode "00A0"x}into:p50_2(*ESC*){unicode "00A0"x}from(*ESC*){unicode "00A0"x}Quartiles';
p'(*ESC*){unicode "00A0"x}where(*ESC*){unicode "00A0"x}Percent=50(*ESC*){unicode "00A0"x}and(*ESC*){unicode "00A0"x}stratum=2;';
p'quit;';
p'';
...
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}styleattrs(*ESC*){unicode "00A0"x}datacontrastcolors=(red(*ESC*){unicode "00A0"x}blue(*ESC*){unicode "00A0"x})';
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}datacolors=(red(*ESC*){unicode "00A0"x}blue(*ESC*){unicode "00A0"x})';
p'(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}datalinepatterns=(solid(*ESC*){unicode "00A0"x}solid)(*ESC*){unicode "00A0"x};';
p'';
p'(*ESC*){unicode "00A0"x}step(*ESC*){unicode "00A0"x}x=time(*ESC*){unicode "00A0"x}y=survival(*ESC*){unicode "00A0"x}/(*ESC*){unicode "00A0"x}group=stratum(*ESC*){unicode "00A0"x}name="step"(*ESC*){unicode "00A0"x}lineattrs=(thickness=2);';
p'(*ESC*){unicode "00A0"x}scatter(*ESC*){unicode "00A0"x}x=time(*ESC*){unicode "00A0"x}y=censored(*ESC*){unicode "00A0"x}/noerrorcaps(*ESC*){unicode "00A0"x}yerrorupper=tick_marks_upper(*ESC*){unicode "00A0"x}yerrorlower=tick_marks_lower(*ESC*){unicode "00A0"x}errorbarattrs=(pattern=1(*ESC*){unicode "00A0"x}thickness=2)(*ESC*){unicode "00A0"x}markerattrs=(size=0)(*ESC*){unicode "00A0"x}GROUP=stratum;';
p'(*ESC*){unicode "00A0"x}band(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}x=time(*ESC*){unicode "00A0"x}upper=SDF_UCL(*ESC*){unicode "00A0"x}lower=SDF_LCL/(*ESC*){unicode "00A0"x}group=stratum(*ESC*){unicode "00A0"x}type=step(*ESC*){unicode "00A0"x}transparency=0.8;';
p'(*ESC*){unicode "00A0"x}dropline(*ESC*){unicode "00A0"x}x=&p50_1.(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}y=0.5(*ESC*){unicode "00A0"x}/dropto=both(*ESC*){unicode "00A0"x}lineattrs=(color=red(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}pattern=dot(*ESC*){unicode "00A0"x}thickness=3);';
p'(*ESC*){unicode "00A0"x}dropline(*ESC*){unicode "00A0"x}x=&p50_2.(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}y=0.5(*ESC*){unicode "00A0"x}/dropto=both(*ESC*){unicode "00A0"x}lineattrs=(color=blue(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x}pattern=dot(*ESC*){unicode "00A0"x}thickness=3);';
p'';
p'';
p'(*ESC*){unicode "00A0"x}xaxistable(*ESC*){unicode "00A0"x}atrisk(*ESC*){unicode "00A0"x}/(*ESC*){unicode "00A0"x}x=tatrisk(*ESC*){unicode "00A0"x}class=stratum(*ESC*){unicode "00A0"x}location=outside(*ESC*){unicode "00A0"x}valueattrs=(size=10(*ESC*){unicode "00A0"x}color=black)(*ESC*){unicode "00A0"x}(*ESC*){unicode "00A0"x};';
p'(*ESC*){unicode "00A0"x}keylegend(*ESC*){unicode "00A0"x}"step"(*ESC*){unicode "00A0"x}/(*ESC*){unicode "00A0"x}location=inside(*ESC*){unicode "00A0"x}position=topright(*ESC*){unicode "00A0"x}across=1(*ESC*){unicode "00A0"x}noborder(*ESC*){unicode "00A0"x}valueattrs=(size=10)(*ESC*){unicode "00A0"x}exclude=("")(*ESC*){unicode "00A0"x};';
p'(*ESC*){unicode "00A0"x}';
p'(*ESC*){unicode "00A0"x}yaxis(*ESC*){unicode "00A0"x}label="Probability"(*ESC*){unicode "00A0"x}min=0(*ESC*){unicode "00A0"x}values=(0(*ESC*){unicode "00A0"x}0.2(*ESC*){unicode "00A0"x}0.4(*ESC*){unicode "00A0"x}0.5(*ESC*){unicode "00A0"x}0.6(*ESC*){unicode "00A0"x}0.8(*ESC*){unicode "00A0"x}1.0(*ESC*){unicode "00A0"x})(*ESC*){unicode "00A0"x}offsetmax=0.03;';
p'(*ESC*){unicode "00A0"x}xaxis(*ESC*){unicode "00A0"x}label="Survival(*ESC*){unicode "00A0"x}Time(*ESC*){unicode "00A0"x}(Month)"(*ESC*){unicode "00A0"x}values=(0(*ESC*){unicode "00A0"x}to(*ESC*){unicode "00A0"x}15(*ESC*){unicode "00A0"x}by(*ESC*){unicode "00A0"x}1)(*ESC*){unicode "00A0"x}offsetmin=0.04(*ESC*){unicode "00A0"x};';
